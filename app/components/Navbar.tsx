...
export default function Navbar() {
  ...
  return (
    <nav className="flex fixed top-0 left-0 z-40 w-32 h-screen transition-transform  sm:translate-x-0 flex-col justify-between text-white bg-teal-700 p-0 md:p-6 lg:justify-evenly">
      <FontAwesomeIcon
      ...
      >
        <Link
          className="hover:bg-teal-800 p-4 rounded-xl w-fit lg:inline"
          href="/"
        >
          Home
        </Link>
